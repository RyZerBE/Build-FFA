...
class DiverseBossBar extends BossBar{
	...
	#[Pure] public function getTitleFor(Player $player): string{
	...
	#[Pure] public function getSubTitleFor(Player $player): string{
	 ...
	 * @return string
	 */
	#[Pure] public function getFullTitleFor(Player $player): string{
	...
	public function getPropertyManager(Player $player = null): EntityMetadataCollection{
		...
		if ($player instanceof Player)
			$propertyManager->setString(EntityMetadataProperties::NAMETAG, $this->getFullTitleFor($player)); else $propertyManager->setString(EntityMetadataProperties::NAMETAG, $this->getFullTitle());
