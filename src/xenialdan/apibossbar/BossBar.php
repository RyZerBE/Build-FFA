...
class BossBar{
	...
	public function __construct(){
		...
		$this->propertyManager->setLong(EntityMetadataProperties::FLAGS, 0 ^ 1 << EntityMetadataFlags::SILENT ^ 1 << EntityMetadataFlags::INVISIBLE ^ 1 << EntityMetadataFlags::NO_AI ^ 1 << EntityMetadataFlags::FIRE_IMMUNE);
	...
	public function setEntity(?Entity $entity = null): BossBar{
		...
		if ($this->getEntity() instanceof Entity && !$entity instanceof Player)
			$this->getEntity()->flagForDespawn(); else {
